    ...
    <table style="width: 100%;border-collapse: collapse;font-family: poppins,arialuni,notosansjp;"
        cellspacing="1px" class="mainTable">
            <tr style="background-color: #f0efef; color: #000000; font-weight:500; font-family: poppins,arialuni,notosansjp;">
                ...
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.po_id') }}</strong></td>
            ...
            <tr>
                ...
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>PO-{{$res['po_id']}}</strong></td>
    ...
    <footer>
        <script type="text/php">
            if (isset($pdf)) {
               ...
               $pdf->page_text(28,815, "{{ trans('WebSite.po_log') }}", $font, 9, array(0, 0, 0));
