          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            ...
            <div style="margin-top: 35px;">
                ...
                <table style="width :100%;font-family: poppins,sans-serif;" id="DataTable">
                    ...
                    <th class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ trans('WebSite.plannedDate') }}</span></th>
                    <th class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ trans('WebSite.completionDate') }}</span></th>
                    <tr>
                        <td style="text-align:center">1</td>
                        <td class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ $details['taskName'] }}</span></td>
                        <td class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ trans('WebSite.Completed') }}</span></td>
                        <td class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ $details['plannedDate'] }}</span></td>
                        <td class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ $details['completedDate'] }}</span></td>
                    </tr>
                </table>
            </div>
        </div>
