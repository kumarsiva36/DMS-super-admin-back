        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            ...
            <div style="margin-top: 35px;">
                <div>
                    <img src="{{ $message->embed(public_path().'/images/OrderDelay.png') }}" class="center">
                    {{-- <img src="{{ asset('images/OrderDelay.png') }}" class="center"> --}}
                </div>
                <div style="font-weight: 600; color: #188676;text-align:center; font-size:20px; margin-bottom:35px;">{{ trans('WebSite.orderDelayText') }}</div>
