...
<body style="font-family: poppins,arialuni,notosansjp; font-size: 14px;">
        ...
        <table width="100%"  cellpadding="5" cellspacing="0" class="" >
            <tr>
                ...
                <td >
                    ...
                    <strong>{{ trans('WebSite.techpack_log') }} </strong>
                    </div>
                </td>
                <td width="12%">
    ...
    <div >
        ...
        <div style="float:right; font-size:25px; font-weight:600; color: #8C878D; ">
            <strong>{{ trans('WebSite.po_log') }}</strong>
            <div
        ...
        <div style="margin: 5px 0;">
            @if ($request)
                ...
                @if (isset($request->po_id) && $request->po_id !='')
                    <strong style="background-color: #E8E8E8;color:#606060;padding:1px 3px 3px;">{{ trans('WebSite.po_id') .": PO-".$result[0]['po_id'] }}</strong>
                @endif
    ...
    <table style="width: 100%;border-collapse: collapse;font-family: poppins,arialuni,notosansjp;"
        cellspacing="1px" class="mainTable">
            <tr style="background-color: #f0efef; color: #000000; font-weight:500; font-family: poppins,arialuni,notosansjp;">
                ...
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.techpack_id') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.po_number') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.Style') }}</strong></td>
            ...
            <tr>
                ...
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['techpack_id']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['po_no']}}</strong></td>
    ...
    <footer>
        <script type="text/php">
            if (isset($pdf)) {
               ...
               $pdf->page_text(28,815, "Techpack Logs", $font, 9, array(0, 0, 0));
