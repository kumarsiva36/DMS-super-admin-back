    ...
    <div >
        ...
        <div style="margin: 5px 0;">
            @if ($request)
                ...
                @endif
                @if (isset($request->production) && $request->production !='')
        ...
        cellspacing="1px" class="mainTable">
            ...
            <tr>
                ...
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>
                    {{ (IsJson($res['device_details'])) ? ((json_decode($res['device_details'])->platform)??"Web") :"Web"; }}
                    </strong>
                </td>
    ...
    <footer>
        <script type="text/php">
            if (isset($pdf)) {
               ...
               $pdf->page_text(28,815, "{{ trans('WebSite.DataInputLog') }}", $font, 9, array(0, 0, 0));
