          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            ...
            <div style="margin-top: 35px;">
                ...
                <table style="width :100%;font-family: poppins,sans-serif;" id="DataTable">
                    ...
                    <th class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ trans('WebSite.scheduledStartDate') }}</span></th>
                    <th class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ trans('WebSite.scheduledEndDate') }}</span></th>
                    <?php $i=1?>
                    @foreach ($details['taskDetails'] as $detail)
                        <tr>
                            <td style="text-align:center;font-family: poppins,sans-serif;">{{ $i++ }}</td>
                            <td class="tableClass" style="font-family: poppins,sans-serif;"><span>{{ $detail['taskName'] }}</span></td>
