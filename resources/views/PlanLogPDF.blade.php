        ...
        <table width="100%"  cellpadding="5" cellspacing="0" class="" >
            <tr>
                ...
                <td >
                    ...
                    <strong>{{ trans('WebSite.PlanLog') }} </strong>
                    </div>
                </td>
                <td width="12%">
    ...
    <table style="width: 100%;border-collapse: collapse;font-family: poppins,arialuni,notosansjp;"
        cellspacing="1px" class="mainTable">
            <tr style="background-color: #f0efef; color: #000000; font-weight:500; font-family: poppins,arialuni,notosansjp;">
                ...
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.plan_name') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.plan_type') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.plan_purchase') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.account_activated') }}</strong></td>
                <td style="padding : 5px ; font-family: poppins,arialuni,notosansjp;"><strong>{{ trans('WebSite.account_expire') }}</strong></td>
            </tr>
            @foreach ($result as $res)
            <tr>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{date('d M Y',strtotime($res['created_date']))}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['company_name']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['user_name']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['plan_name']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['purchased_plan_type']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['plan_purchase']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['account_activated']}}</strong></td>
                <td style="padding:5px; font-family: poppins,arialuni,notosansjp; font-size: 12px;"><strong>{{$res['account_expire']}}</strong></td>
            </tr>
            @endforeach
    </table>
    <script type="text/php">
        if (isset($pdf)) {
           ...
           $pdf->page_text(28,815, "{{ trans('WebSite.PlanLog') }}", $font, 9, array(0, 0, 0));
